...
AS
DECLARE VARIABLE PORCENTAJE_ACTUAL DECIMAL(18,2);
BEGIN
    ...
    BEGIN
        SELECT PORCENTAJE
        FROM SP_CALCULAR_PORCENTAJE_EJECUCION_MES(:P_ID_SUBCATEGORIA, :P_ID_PRESUPUESTO, :P_ANIO, :P_MES)
        INTO :PORCENTAJE_ACTUAL;

        IF (PORCENTAJE_ACTUAL > 100) THEN
            ADVERTENCIA = 'Esta subcategoria ya supero el monto asignado para el mes';
    END
END^
